...
export const PACDUCK_MESSAGES = {
  profanity: "PacDuck says: QUACK! That language is way too spicy for our pond! 🦆💔",
  ...
  generic: "PacDuck says: *confused quacking* Something went wrong! Try again or give me simpler text! 🦆❓",
} as const;